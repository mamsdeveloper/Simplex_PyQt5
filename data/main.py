...
class TheoryWindow(QWidget):
    def __init__(self):
        ...
        self.setWindowIcon(QIcon(f'{os.getcwd()}\data\Assets\App.ico'))
...
class InfWindow(QWidget):
    def __init__(self):
        ...
        picture_1 = QPixmap(f'{os.getcwd()}\data\Assets\pic1.jpg')
        picture_label_1.setPixmap(picture_1)

        picture_label_2 = QLabel()
        picture_2 = QPixmap(f'{os.getcwd()}\data\Assets\pic2.jpg')
...
class MainWindow(QMainWindow):
    ...
    def __init__(self):
        super().__init__()
        ########
        f = open(f'{os.getcwd()}\data\Assets\style.qss', 'r')
